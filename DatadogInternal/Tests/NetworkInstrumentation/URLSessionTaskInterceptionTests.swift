...
class URLSessionTaskInterceptionTests: XCTestCase {
    func testWhenInterceptionIsCreated_itHasUniqueIdentifier() {
        // When
        let interception1 = URLSessionTaskInterception(request: .mockAny())
        let interception2 = URLSessionTaskInterception(request: .mockAny())
    ...
    func testWhenInterceptionReceivesData_itAppendsItToPreviousData() {
        ...
        let interception = URLSessionTaskInterception(request: .mockAny())
