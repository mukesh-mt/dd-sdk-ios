...
public protocol DatadogURLSessionInterceptor {
    ...
    func modify(request: URLRequest, additionalFirstPartyHosts: FirstPartyHosts?) -> URLRequest
...
internal struct NOPDatadogURLSessionInterceptor: DatadogURLSessionInterceptor {
    /// no-op
    func modify(request: URLRequest, additionalFirstPartyHosts: FirstPartyHosts?) -> URLRequest { request }
    /// no-op
