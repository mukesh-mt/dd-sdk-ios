...
public final class URLSessionInterceptorMock: DatadogURLSessionInterceptor {
    ...
    public var onRequestMutation: ((URLRequest, FirstPartyHosts?) -> Void)?
    ...
    public func modify(request: URLRequest, additionalFirstPartyHosts: FirstPartyHosts?) -> URLRequest {
        onRequestMutation?(request, additionalFirstPartyHosts)
